...
- **Templates** (`CLAUDE.md`, `work.json`, `.code-workspace`, `context/INDEX.json`) → `/templates/`. tsup copies them into `npm/templates/` on every build. Runtimes pick up changes only after `mx update`.
