...
Prune **orphaned** mx tmux sessions — live `mx/<work>` sessions whose work, in this runtime, is **archived** or **no longer exists** (a stray session left after something went sideways); `gc` finds and kills those.
